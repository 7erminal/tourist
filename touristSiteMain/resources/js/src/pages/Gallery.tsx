        ...
        <Navbar sticky="top" bg="light" expand="lg">
            <Container>
                ...
                <Nav className="mx-auto">
                    <Nav.Link className="mx-4" href="#home"><a href="#images" className="navLink" onClick={()=>scrollToView('images')}>Images</a></Nav.Link>
                    <Nav.Link className="mx-4" href="#gallery"><a href="#videos" className="navLink" onClick={()=>scrollToView('videos')}>Videos</a></Nav.Link>
                </Nav>
            </Container>
        </Navbar>
